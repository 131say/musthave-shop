      ...
      <main className="mx-auto w-full max-w-2xl px-4 py-16">
        <div className="rounded-2xl border bg-white p-8 dark:border-neutral-800 dark:bg-neutral-900">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300">Вы теперь участник клуба.</p>
            ...
            <div className="mt-8 space-y-6 text-left">
              <div className="flex items-start gap-4 rounded-xl border p-4 dark:border-neutral-800">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">С каждой покупки вам начисляется кэшбэк</p>
                </div>
              </div>
              <div className="flex items-start gap-4 rounded-xl border p-4 dark:border-neutral-800">
                <span className="text-2xl">🔗</span>
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">Скопируйте вашу реферальную ссылку и отправьте друзьям</p>
                </div>
              </div>
              <div className="flex items-start gap-4 rounded-xl border p-4 dark:border-neutral-800">
                <span className="text-2xl">💰</span>
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">Когда ваши друзья покупают, вы получаете бонусы. Также бонусы начисляются за покупки друзей ваших друзей</p>
                </div>
              </div>
            </div>
            <div className="mt-8 space-y-3">
        ...
        <div className="rounded-2xl border bg-white p-8 dark:border-neutral-800 dark:bg-neutral-900">
          <div className="text-center">
            ...
            <div className="mt-8 rounded-xl border bg-gray-50 p-4 dark:border-neutral-800 dark:bg-neutral-800">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Делитесь только с теми, кому реально советуете.</p>
            </div>
            <div className="mt-8 space-y-3">
              <button
                onClick={completeOnboarding}
